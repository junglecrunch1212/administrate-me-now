"""
Metadata sheet builder for adminme-finance.xlsx [read-only].

Per ADMINISTRATEME_BUILD.md §3.11 finance Sheet 7 shape. Small provenance
sheet so the principal can verify what projection state produced the file.
"""
...
def build(
    ...
    *,
    ...
    rows: list[tuple[str, str]] = [
        ("workbook_name", "adminme-finance.xlsx"),
