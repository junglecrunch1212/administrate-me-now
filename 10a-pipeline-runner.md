...
Build `platform/pipelines/runner.py`. Build `platform/pipelines/base.py` with the Pipeline protocol. Install a trivial test pipeline to prove the loop.
