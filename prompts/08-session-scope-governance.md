...
- `adminme/lib/session.py` — Session dataclass + constructor from various inputs; view-as validation.
- `adminme/lib/scope.py` — query-time scope filter helpers; privacy filter for privileged content.
- `adminme/lib/governance.py` — guardedWrite three-layer check; action_gates loader; RateLimiter.
- `adminme/lib/observation.py` — observation wrapper; suppressed-event emission; configuration.
