...
2. `adminme/projections/xlsx_workbooks/forward.py` and `reverse.py`.
...
# Specifically:
poetry run pytest adminme/projections/xlsx_workbooks/tests/test_no_spurious_reverse_events.py -v
```
