...
Migrations live in `platform/migrations/`. Each is a Python file with a single `MIGRATION = Migration(...)` declaration.
...
git add platform/cli/ platform/lib/migrations.py platform/migrations/ deploy/ tests/
