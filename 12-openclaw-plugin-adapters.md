...
### `platform/openclaw_plugins/memory_bridge/`
...
### `platform/openclaw_plugins/channel_bridge_bluebubbles/`
...
`platform/openclaw_plugins/_shared/bridge_base.py` — common code for all channel bridges (message normalization, sensitivity defaulting, dedup).
...
```bash
openclaw plugin install platform/openclaw_plugins/memory_bridge
openclaw plugin install platform/openclaw_plugins/channel_bridge_bluebubbles
...
# Manifest validation
poetry run python -c "
from platform.openclaw_plugins._shared.bridge_base import validate_manifest
validate_manifest('platform/openclaw_plugins/memory_bridge')
validate_manifest('platform/openclaw_plugins/channel_bridge_bluebubbles')
