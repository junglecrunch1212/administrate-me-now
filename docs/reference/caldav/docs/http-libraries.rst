..
   Source: https://github.com/python-caldav/caldav/blob/master/docs/source/http-libraries.rst
   Fetched: 2026-04-22
   License: Apache-2.0 OR GPL-3.0 (dual-licensed; caldav/COPYING.APACHE, COPYING.GPL)
