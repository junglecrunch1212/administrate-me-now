---
source_url: https://developer.apple.com/documentation/eventkit/updating-with-notifications
fetched: 2026-04-22
page_title: Updating with notifications
---
...
> **Note:** The URL originally requested (`/documentation/eventkit/responding-to-calendar-database-changes`) returns a 404. Apple appears to have renamed this page to `updating-with-notifications`. Content below is from the current canonical URL.
