...
fetched: 2026-04-22
page_title: Accessing the event store
---
...
> **Important:** On iOS 17 or later, if your app doesn't include usage description keys, or only includes the older `NSCalendarsUsageDescription` key for describing events access, iOS automatically denies any access request.
