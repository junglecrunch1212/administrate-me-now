...
**Prompts drafted, ready for Claude Code execution:** none. Next refactor target: **09b** (canonical `classify_thank_you_candidate` pack as first real consumer of the wrapper).
